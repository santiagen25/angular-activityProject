...
export class DeleteComponent implements OnInit, CanComponentDeactivate {
  ...
  public deleteData(){
    return Swal.fire({
      ...
      if(result.value) this.generalService.deleteDB(this.obj.name, this.obj.date, this.obj.id);
    })
